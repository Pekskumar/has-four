...
function Privacy_policy () {
	return(
		...
		/>
		<section className="term_condition responsive-padding">
		<div className="container">
		<h2>Introduction</h2>
<ol>
   <li><strong>Standard Terms</strong></li>
</ol>
...
<h3>Contact Us</h3>
<p>The laws of Hong Kong, and you submit to the non-exclusive jurisdiction of the state and federal courts located in Hong Kong for.</p>
<p><NavLink to="tel:+91 8866808798">+8866808798</NavLink></p>
<NavLink to="mailto:prakash.montu_92@live.com">prakash.montu_92@live.com</NavLink>
